...
# Step 1 - Authenticate
consumer_key= 'DUFq4nKJ47xe7OKamOJjgFHmw'
consumer_secret= 'HRBHS3opm4xlAUxJp5GoKeFPmlqRQ4qQ1TXgmo8Q7LplsglSuW'

access_token='29968339-iv431pemubtyN8b7Z7jMqfCFrrVlUFGuV24cDaASP'
access_token_secret='cqerzhStHLzQqIaWb73Ta9YFlAaFu91XKlbHwli1W29A5'
...
public_tweets = api.search(input("Enter a subject to search on Twitter: "))
...
def average_polarity(pol):
    for item , val in enumerate(pol):
        val +=val # addition toute les vel
        if item == len(pol): # if my loop is completed
            val= val/len(pol) # diviser par le nombre de val
